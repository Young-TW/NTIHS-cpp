...
for i in range(3):
    ...
    for j in range(30):
        print("Student ID : ")
        print(s)
        print(f"Chinese ==> [ {score[i][j][0]} ] \n")
        print(f"English ==> [ {score[i][j][1]} ] \n")
        print(f"Math    ==> [ {score[i][j][2]} ] \n")
        s=s+1
...
while 1:
    ...
    if input == 1:
        ...
        for j in range(30):
            print("Student ID : ")
            print(f"{s}\n")
            print(f"Chinese ==> [ {score[1][j][0]} ] \n")
            print(f"English ==> [ {score[1][j][1]} ] \n")
            print(f"Math    ==> [ {score[1][j][2]} ] \n")
            s=s+1
        print("==========================================================================================\n")
        print("Choice class 1 - 3 , 4 for all , C ==> Chinese , E ==> English , M ==> Math , 0 to eixt >>")
    elif input == 2:
        ...
        for j in range(30):
            print("Student ID : ")
            print(f"{s}\n")
            print(f"Chinese ==> [ {score[2][j][0]} ] \n")
            print(f"English ==> [ {score[2][j][1]} ] \n")
            print(f"Math    ==> [ {score[2][j][2]} ] \n")
            s=s+1
        print("==========================================================================================\n")
        print("Choice class 1 - 3 , 4 for all , C ==> Chinese , E ==> English , M ==> Math , 0 to eixt >>")
    elif input == 3:
        ...
        for j in range(30):
            print("Student ID : ")
            print(f"{s}\n")
            print(f"Chinese ==> [ {score[3][j][0]} ] \n")
            print(f"English ==> [ {score[3][j][1]} ] \n")
            print(f"Math    ==> [ {score[3][j][2]} ] \n")
            s=s+1
        print("==========================================================================================\n")
        print("Choice class 1 - 3 , 4 for all , C ==> Chinese , E ==> English , M ==> Math , 0 to eixt >>")
    elif input == 4:
